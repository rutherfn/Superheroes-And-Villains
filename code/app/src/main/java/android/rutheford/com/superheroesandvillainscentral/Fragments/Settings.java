...
public class Settings extends Fragment
{
    ...
    private void addToList(){
        if(sizeOfSettings.size() < 1)
        {
            ...
            sizeOfSettings.add(new SettingModel("View Purchase Characters","View current characters purchase throughout the app, and have the ability to switch between characters! ",R.drawable.ironman));
